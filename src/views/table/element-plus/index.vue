...
const getTableData = () => {
  loading.value = true
  const startTime = searchData.dataTime && searchData.dataTime[0] ? searchData.dataTime[0]) : undefined
  const endTime = searchData.dataTime && searchData.dataTime[1] ? formatDate(searchData.dataTime[1]) : undefined
